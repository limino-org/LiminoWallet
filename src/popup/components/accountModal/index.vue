<template>
  ...
  >
    <div class="account-container">
      <div class="title text-center  bold van-hairline--bottom">{{ t("account.account") }}</div>
      <div class="account-list" id="account-list">
        <!-- Non-imported accounts -->
        <div class="f-12 lh-16 accountList-tit" v-show="defaultlist.length">{{ t("account.createaccount") }}</div>
        <div
        ...
        <!-- Imported accounts -->
        <div v-if="importList.length" class="f-12 lh-16 accountList-tit">{{ t("account.importaccount") }}</div>
        <div
      ...
      <div class="flex between btn-group van-hairline--top pt-20">
        <div class="flex between btn-group-box">
          <div class="btn-box">
            ...
            <div class="text-center text text-bold lh-16">{{ t("account.create") }}</div>
          </div>
          <div class="btn-box" @click="toImport">
            <div class="btn flex center">
              <i class="iconfont icon-xiazai"></i>
            </div>
            <div class="text-center text text-bold lh-16">{{ t("account.import") }}</div>
          </div>
        </div>
      </div>
    </div>
