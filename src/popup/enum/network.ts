...
export const netWorklist: Array<NetWorkData> = [
    { color:'rgb(14, 126, 33)', label: "Wormholes", select: false ,URL, chainId: 51888, currencySymbol: 'ERB', browser:'https://www.wormholesscan.com',transactionList:{},tokens:{},id: 'wormholes-network-1', isMain: true  },
