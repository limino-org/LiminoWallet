      ...
      <div class="userinfo slider-box amount-info pt-20 pb-20 pl-14 pr-14">
        <div class="flex between">
          ...
          <div class="gasfee-icon flex center-v hover">
            <i class="iconfont icon-shaixuan" @click="toSetGas"></i>
          </div>
        </div>
      </div>
    </div>
    <!-- <div class="tip-box">
      <div class="pl-16 pr-16 container" v-if="isPoor">
        <div class="box flex p-12">
          <div class="icon flex center mr-8 h-16">
            <van-icon name="warning" />
          </div>
          <div class="lh-16">{{ t("sendto.missingassets") }}</div>
        </div>
      </div>
    </div> -->
...
import { useTradeConfirm } from "@/popup/plugins/tradeConfirmationsModal/index";
