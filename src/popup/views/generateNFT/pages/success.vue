<template>
    ...
    <div class="icon-box flex center">
      <div class="iconele flex center" :style="{backgroundImage: `url(${require('@/popup/views/createNft/imgs/circle.png')})`}">
        <div class="iconinner flex center" :style="{backgroundImage: `url(${require('@/popup/views/createNft/imgs/circle1.png')})`}">
          <!-- <i class="iconfont icon-duigouxiao"></i> -->
          <img src="@/assets/token/success.png" class="success" alt="">
        </div>
      </div>
    </div>
    <div class="tip">
