    ...
    <div class="flex between">
      <div class="collection-card-left flex">
        <div class="token-icon flex center">
          <div
            :class="`token-icon-box flex center ${handleBTCSendStatus(data)}`"
          >
            <i
              :class="`iconfont  ${
                txTypeToIcon(data)
        ...
        <div class="token-info flex center">
          <div>
            <div class="name">
              {{ handleTxType(data) }}
              <span :class="`status ${transactionBTCStatusClass(data)}`">
                {{ transactionBTCStatus(data) }}
              </span>
            </div>
            <div class="amount">
      ...
      <div class="collection-card-right flex center">
        <div>
          <div class="van-ellipsis text-right val lh-18">
            {{transferBTCAmountText(data)}} BTC
          </div>
        </div>
      </div>
    </div>
