  ...
  <div class="creator">
    ...
    <div class="text-center pl-30 pr-30 creatorTip">
        <i18n-t tag="div" keypath="creatorSnft.tip" class="lh-16">
            <template v-slot:link1><a href="http://" target="_blank" class="link" rel="noopener noreferrer">{{ t('creatorSnft.exchange') }}</a></template>
            <template v-slot:link2><a href="http://" target="_blank" class="link" rel="noopener noreferrer">{{ t('creatorSnft.browser') }}</a></template>
        </i18n-t>
    </div>
  </div>
</template>
...
import { AppProvide } from "@/popup/provides/app";
