export default {
  ...
  bourse: {
    placename: "Please enter name of the exchange",
    ...
    dialogTitle: "Information Confirm",
    ...
    periodAdd:"Server Period Additional",
    addServeAmount:"You can rent our server for your exchange which has to pay 200ERB a year.After paying,you will be able to set up your exchange on our server.",
    ...
    closeTip:"Sorry，the estimated closing time of the exchange is 1 year.",
  ...
  wallet: {
    ...
    NFTs: "NFTs",
    SNFTs: "S-NFTs",
    token: "Don’t see your Token ?",
    importToken: "Import Tokens",
    createAnExchange: "AUTO EXCHANFGE",
    notoken: "Can't you find your {type}?",
    addtoken: "Add tokens",
    ...
    back:'Back',
    cancel:'Cancel',
    toBrowser:"View full history on Etherscan",
  ...
  addtokens: {
    title:
      "Existing fake version tokens can be created. You can visit {wormholesLink} to learn more.",
  ...
  introductorypage: {
    ...
    bootstrap2: "The most trust",
    bootstrap3: "Track spending",
    bootstrap4: "Effortlessly Save",
    bootstrap1title:
      "we are dedicated to solving your virtual asset management problems.",
    bootstrap2title:
      "You can view your assets at any time, trade and exchange your assets.",
    bootstrap3title:
      "You can have a NFT TRADING  PLATFORM through just one click!",
    bootstrap4title:
      "Adopts advanced security encryption mode to ensure the security of assets.",
    login: "Log In",
    create: "Creat an Account",
  },
  // Create account page
  createAccountpage: {
    createAccount: "Creat Passwords",
    ...
    cantLogin: "Can't login? You can setup a new one",
    resentWallet: "Resent Wallet",
    ...
    mnemonic: "Mnemonic",
    checkLaw:"Please check the Privacy policy",
    pwdRequired:"The password cannot be empty ",
    pwdWorng:"Password length 6-20 digits",
    pwdMessage:'More than 5 characters and less than 20 characters',
    inconsistentPwd:"The entered passwords are inconsistent",
    mnemonicBtn:"Secret Recovery Phrase",
    mneTit:"Import by Recovery Phrse",
    iptMne:"Please enter Secret Recover",
    recoMne:"Recovery Phrase",
    mneWarn:"Not in the correct format",
    yinsi:"I have read and accepted the user's agreement {term} and {privacy}",
    terms:"Terms of Use",
  ...
  sign: {
    ...
    pleaseConfirm: " Please confirm the signature informations",
    content: "Content:",
    cancel: "Cancel",
    confirm: "Confirm",
    nodatatosign:'No data to sign',
    copysuccessfully:'Copy successfully',
    ordinarysignature:'Ordinary signature',
  ...
  mnemonic: {
    ...
    backUp: "BackUp",
    hint1:
      "Write down or copy these words in the right order and keep them in a safe plac.",
  ...
  exchange: {
    autoExchange: "Auto Exchange",
    welcome: "Welcome",
    withUs: "Let’s Join With Us",
    name: "Name",
    namePlaceholder: "This NFT Name Is Stock Exchange",
    stake: "Staking",
    yield: "yield",
    custom: "Custom",
    server: "Server",
    balance: "Balance",
    max: "Max",
    confirmTerms: "Confirmation of Terms & Conditions",
    confirm: "Confirm",
    setAmount: "Set Amount",
    reset: "Reset",
    waitingMoment: "Waiting Moment ",
    please: "Please...",
    congratulations: "Congratulations",
    ...
    exchange: "Exchange",
    message:
      "Directly click the link to access! Copy or share this link with a friend who will be able to access it.",
    successfullyadded:'The additional pledge amount was successful!',
    closedsuccessfully:'The exchange closed successfully!',
  ...
  sendNFT: {
    ...
    more: "More",
    to: "To",
    addAddress: "Add to Input or Paste or QRcorded",
    errorAddress:
  ...
  sendSNFT: {
    ...
    recent: "Recent",
    contacts: "Contacts",
    pleasechoose:'Please select the snft to be redeemed',
    pleaseselect:'Please select the snft fragment to send',
    notselected:'You have not selected any snft shards you want to redeem',
    all: "All",
    buysnft:' You can also {snf} at the exchange',
    snf:'Buy SNF',
    cancel:'Cancel',
    moreInfo:'More Info',
    loading:'Loading...',
    loadchip:"Data is being prepared, please wait",
    collTit:"COLLECTION"
  ...
  importToken: {
    ...
    custom: "Custom",
    message:
      "Improved token detection is available on Ethereum Mainnet as an experimental feature.",
    searchTokes: "Search Tokes…",
    default: "Default",
    popUps: "Operation Succeeded",
    customMessage:
      "It is possible to create fake versions of existing tokens. Viisit the WormHoles to learn more.",
    tokenContractAdd: "Token Contract Add",
    tokenContractAddPlaceholder: "e.g. 0X…",
    tokenName: "Token Name",
    tokenNamePlaceholder: "e.g. AIT",
    tokenSymbol: "Token Symbol",
    tokenSymbolPlaceholder: "e.g. GNO",
    tokenofDecimal: "Token of Decimal",
    tokenofDecimalPlaceholder: "e.g. 01",
    cancel: "Cancel",
    import: "Import",
    customPopUps: "Import Succeeded",
    warn:"The current network does not support the token"
  ...
  send: {
    ...
    fee: "Fee",
    sendMessage:
      "Your account is short of assets. Please make sure there are amounts available for transfer.",
    confirm: "Confirm",
    ...
    addressError:"You entered is not in the correct format",
  ...
  sendto: {
    ...
    nomoney:
      "Your account has 0ETH available to pay transaction fees. Buy some ETH or deposit it from another account.",
    ...
    gasprice: "Gas Price",
    gastit:
      " Gas fees are paid to crypto miners who process transactions on thenetwork. Wormholes does not profit from gas fees. Gas fees are setby the network and fluctuate based on network traffic and transaction complexity.",
    ...
    nametip:"Name",
    chargetip:"Commission Charge ",
    feetip:"Pledge fee ",
    servertip:"Server ",
    amounttip:"Total Amount ",
    gastip:"Gas Fee "
  },
  //  Transaction popup
  returnreceipt: {
  ...
  network: {
    ...
    create: "Create",
    import: "Import",
    accountNameModification: "Account name modification",
    ...
    importMessage:
      "Improved accounts are viewable in your wallet but are not recoverable with your WormHoles Secret Recovery Phrase.Viisit here to learn more.",
    inputPrivateKey: "Input Private Key",
    scanQRCode: "Scan QR Code",
    forexample:
      "e.g.3a1076bf45ab87712ad64ccb3b10217737faacbf2872e88fdd9a537d8fe266",
    importSucceeded: "Import Succeeded",
  },
  // sidebar
  sidebar: {
    recive: "Recive",
    shareMyPublicAddress: "Share My Public Address",
    transationHistory: "Transation History",
    settings: "Settings",
    autoNFTExchange: "Auto NFT Exchange",
    openExchange: "Open my exchange",
    minerpledge:'Miners Pledge',
  ...
  setting: {
    ...
    walletSecretRecoveryPhrase: "Secret Recovery Phrase",
    networks: "Networks",
  ...
  bootstrapwindow: {
    ...
    wormHoles: "WormHoles 1.0",
    wormHolesMessage:
      "Welcom to WormHolesWe‘ve prepared some tipsto get started quickly",
    wormHolesMessageEnd:
      "Congratulations on your successful completion start a wonderful journey",
    accout: "Accout",
    accountMessage:
    ...
    sNFTs: "S-NFTs",
    sNFTsMessage: "View,Add,Transfer,Exchange S-NFTs",
    exchange: "EXCHANGE",
  ...
  transactiondetails:{
    ...
    success:"Success",
    fail:"Fail",
    tradeTit:"Information Confirm"

},
  // other
  other: {
    youareOffline: "You are Offline",
    tryAgaintitle: " Check your Internet link and  try again",
    tryAgain: "Try Again",
    somethingWentWrong: "Something went wrong",
    plaeseTryAgain: "Please refresh and try again",
    refresh: "Refresh",
  },
  ...
  account: {
    ...
    create: "Create",
    accountname: "Account Name",
    successful:'Successfully modified',
    placeholder:'Please enter account name',
    message:'Name is required',
    accountNameModific:'Account Name Modific',
  ...
  import: {
    importaccount: "Import Account",
    announcement:
      "The imported account is viewable in your wallet, but cannot be retrieved through Wormholes mnemonic.",
    learnmore: "Learn more about the imported accounts here.",
    copy: "Paste your private key string",
    forexample:
      "e.g 3a1076bf45ab87712ad64ccb3b10217737faacbf2872e88fdd9a537d8fe266",
    ...
    scan: "Scan QR Code",
    hint: " Improved accounts are viewable in your wallet buare not recoverable with your WormHoles Secret Recovery Phrase {a}",
    hintatag:"Viisit here to learn more"
  },
  // importerror
  importerror: {
    oops: "Oops! there is a problem…",
    cannotenter:
      "We could not import the private key, please make sure you enter it correctly",
    sure: "OK",
    inputofprivatekey:'Only supports input of private key',
  },
  // importsuccess
  importsuccess: {
  ...
  //  resetPwd
  resetPwd: {
    confirmpasswords: "Confirm New Passwords",
    authentication: "Please enter the password for authentication",
    password: "Password",
    input: "Enter your password",
    confirm: "Confirm",
    password1: "password can not be blank",
    password2:
      "The password format is incorrect, it must contain any combination of uppercase and lowercase, numbers, and special characters, and the length is 1-18 digits",
  ...
  exportprivatekey: {
    ...
    saveQRcode: "Save QR Code to album",
    qrcode: "QR Code",
    copytext: "Copy Text",
    unlockP:"Enter your password…"
  },
  //recoveryPhrase
  recoveryPhrase: {
    warn: "DO NOT share this phrase with anyone! These words can be used to steal all your accounts. Save them somewhere safe and secret."
  },
  // addNetwork
  addNetwork: {
    newnetwork: "New RPC Network",
    introduce:
      " Use a custon RPC-capable network via URL Instead of one of the provided networks.",
    networkname: "Netwok Name",
    networknameoptional: "Netwok Name(optional)",
    inputnetworknameoptional: "Please fill in the Network Name",
    rpcurl: "RPC URL",
    newrpcurl: "New RPC Network",
  ...
  transferNft: {
    ...
    conversionconfirmation:
      "Once converted, it is irreversible,please confirm whether toconvert it",
    all: "All",
    select: "Select",
    convert: "Convert",
    confirmconversion: "Please confirm whether to convert it",
    singleconversionlow: "At present, the yield of single conversion is low:",
    amount: "Amount",
    singleconversionhigh: "The yield of conversion after synthesis is high:",
    overallvalue: "Total value",
    bypledge: "By pledge",
    gaingreaterbenefits: "Gain greater benefits",
    buyatexchange: "You can also Buy SNFT at the exchange",
    cancel: "Cancel",
    confirm: "Confirm",
    ratio: "Ratio",
    name: "Name",
  ...
  createExchange: {
    ...
    name: "Name ({length}/30)",
    nameplaceholder: "The name is for the Exchange",
    namemessage: "Exchange name must be longer than 4 characters",
    amount: "Amount",
    close: "Close",
    cancel: "Cancel",
    confirm: "Confirm",
    ...
    exchange: "Exchange",
    cms: "CMS",
    opensuccessfully: "Congratulations,Open Successfully",
    wait: "Wait for a moment, please",
    title:
      " The minimum amount is 300ERB. You can also set it higher than 300ERB to obtain higher interests",
    welcome: "Welcome to join us",
    openExchange: "Open my exchange",
    welcometo: "Welcome",
    stake: "Staking",
    takesabout: "Takes about 1 day to get ≈",
    max: "Max",
    customize: "Customize",
    server: "Server:",
    selectserver: "Please select whether to rent the server",
    goHome: "GoHome",
    lawTitle: "Articles of law",
    please:'Please...',
    alreadyopenedanexchange:'already opened an exchange',
    oneclickexchangewascreatedsuccessfully:'The one-click exchange was created successfully, please deploy the server yourself',
    agree_checkbox:"Please check the Terms & Conditions",
    have_money:"Please make sure your account balance is adequate  ",
    open_exchange:'Open the exchange',
    openyourself:'You also need to open the exchange yourself',
    gohome:'Go Home',
    termsofservice:'Terms of Service',
    haveread:"I have read and accepted the user's agreement",
    agree:'I Agree',
    accessExchange:'Access Exchange',
    accessCMS:'Access CMS',
    congratulations:' Congratulations, the modification is successful',
    exchangeTit:"My Exchange",
    fee_rate:"Commission Charge",
    fee_rate_tit:"Cannot be changed after setting",
    fee_tit:"Pledge fee",
    pop_card1:"Here is the meaning of the text，Here is the meaning of the text",
    pop_card2:"After paying 200 ERB, your exchange will go online immediately. You will accept the Terms & Conditions for details.",
    ...
    create_success:"The exchange has been successfully opened for you!",
    ...
    setTit:"Set Commission",
    placeholder:"Enter 1-10",
    chargetip:"Here is the meaning of the text，Here is the meaning of the text",
    nametip:"Here is the meaning of the text，Here is the meaning of the text",
    feetip:"Tips: The pledge period is one year. Please check the terms and regulations for details.",
    nameTit1:"Wormholes Exchange",
    nameTit2:"Wormholes CMS",
    redemption:"Redemption",
    snft:"S-NFT",
    desc1:"You can stake your S-NFTs and you will have a chance to get rewards when a new block is created.",
    desc2:"Click this button and you can redeem your staking S-NFTS.",
    exchangeDesc:"Sell,Buy,Mint",
    console:"Console",
    consoleDesc:"Exchange Management",
    staking:"Staking & Redemption",
    stakingDesc:"Add staking or redeem your staking",
  ...
  createExchangeSuccess: {
    ...
    accessexchange: "Access Exchange",
    accesscms: "Access CMS",
    exchangeBtn:"The exchange has been successfully opened, please deploy the server yourself"
  },
  // transactionConfirmComponent
  transactionConfirmComponent: {
    amount: "AMOUNT",
    estimatedgassfree: "Estimated gass free",
    inSecnds: "Like in 30 Secnds",
    total: "Total",
    maxfee: "Max fee:",
    maxaccount: "Max Accpunt:",
  },
  // networklist
  networklist: {
    network: "Network",
  ...
  // categoryform
  categoryform:{
    categoryform:'You have not selected any data'
  },
  ...
  // transferNFTModal
  transferNFTModal:{
    exchangesuccessfully:'Exchange successfully!'
  },
  userexchange:{
...
restWallet:{
  ...
  metaMaskdoesnothave:'WormHoles does not have',
 ...
 currencyList:{
  ...
  importerror:'Token contract error',
